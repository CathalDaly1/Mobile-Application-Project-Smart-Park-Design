            ...
            public void onMapReady(GoogleMap googleMap) {
                    ...
                    public void onClick(View view) {
                        ...
                        mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                            ...
                            public void onInfoWindowClick(Marker marker) {
                                Intent intent = new Intent(MapsActivity.this,listViewOfAreas.class);
                        ...
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.672229, -8.576839)).title("Behind Kemmy Business School Staff Parking").snippet("1.00p/h")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW)));
                        ...
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.672947, -8.567456)).title("Milford Staff Parking").snippet("1.00p/h")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW)));
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.674456, -8.579134)).title("Schrodinger Staff parking").snippet("1.99p/h")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_YELLOW)));
                ...
                btnCarPark.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.674456, -8.579134)).title("Kemmy public parking").snippet("1.99p/h")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
                        ...
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.672545, -8.564906)).title("East Gates Parking").snippet("Free")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.680501, -8.571470)).title("North Campus 4G Pitches").snippet("Free")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.680501, -8.571470)).title("Pavilion Parking").snippet("Free")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
                        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(52.673156, -8.571969),15));
                ...
                Button residentalBtn = (Button) findViewById(R.id.residentalBtn);
                residentalBtn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Log.d("OnClick", "Free Car Parks Button Pressed");
                        mMap.clear();
                        ...
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.679132, -8.568459)).title("Cappavilla Student Village Parking - Residential Only").snippet("Residental")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)));
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.675231, -8.560422)).title("Kilmurry Village - Residential Parking").snippet("Residental")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)));
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.680380, -8.576414)).title("Thomand Village - Residential Parking").snippet("Residental")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)));
                        mMap.addMarker(new MarkerOptions().position(new LatLng(52.667922, -8.573695)).title("Plassy Village - Residential Parking").snippet("Residental")
                                .icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_AZURE)));
                        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(52.673156, -8.571969),15));
                        Toast.makeText(MapsActivity.this,"Residental Car Parks in the University of Limerick", Toast.LENGTH_LONG).show();
                    }
                });
            }
